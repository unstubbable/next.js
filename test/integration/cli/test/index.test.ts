...
describe('CLI Usage', () => {
      ...
      describe('start', () => {
        ...
        test('should format IPv6 addresses correctly', async () => {
          ...
          const app = await runNextCommandDev(
            ['start', dirBasic, '--hostname', '::', '--port', String(port)],
            undefined,
            {
              nextStart: true,
              onStdout(msg) {
  ...
  describe('dev', () => {
    ...
    test('--hostname', async () => {
      ...
      let output = ''
      const app = await runNextCommandDev(
        [dirBasic, '--hostname', '0.0.0.0', '--port', String(port)],
        undefined,
        {
          onStdout(msg) {
            output += stripAnsi(msg)
    ...
    test('-H', async () => {
      ...
      let output = ''
      const app = await runNextCommandDev(
        [dirBasic, '-H', '0.0.0.0', '--port', String(port)],
        undefined,
        {
          onStdout(msg) {
            output += stripAnsi(msg)
    ...
    test('--experimental-https', async () => {
      ...
      let output = ''
      const app = await runNextCommandDev(
        [dirBasic, '--experimental-https', '--port', String(port)],
        undefined,
        {
          onStdout(msg) {
            output += stripAnsi(msg)
    ...
    test('should format IPv6 addresses correctly', async () => {
      ...
      let output = ''
      const app = await runNextCommandDev(
        [dirBasic, '--hostname', '::', '--port', String(port)],
        undefined,
        {
          onStdout(msg) {
            output += stripAnsi(msg)
